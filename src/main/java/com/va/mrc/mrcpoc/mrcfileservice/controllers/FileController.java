package com.va.mrc.mrcpoc.mrcfileservice.controllers;

import com.va.mrc.mrcpoc.mrcfileservice.services.FileService;
import com.va.mrc.mrcpoc.mrcfileservice.dto.FileUploadResponse;
...
public class FileController {
    ...
    public ResponseEntity<List<FileUploadResponse>> uploadMultipleFiles(@RequestParam("files") MultipartFile[] files) {
        return (ResponseEntity<List<FileUploadResponse>>) Arrays.asList(files)
                .stream()
